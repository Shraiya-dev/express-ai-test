...
{{{{
    "action": "Final Answer",
    "action_input": string // You should put what you want to return to use here and make sure to use valid json newline characters as a mandatory tranformation. Do not introduce new line characters outside the action_input
}}}}
\`\`\`
